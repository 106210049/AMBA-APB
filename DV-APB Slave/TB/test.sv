...
program apb_test(apb_if vif);
  ...
  initial begin
    ...
    // `elsif ERROR_RESP
    //     testname = "ERROR_RESP";
    // `elsif READ_WAITING_STATE
    //     testname = "READ_WAITING_STATE";
    // `elsif WRITE_WAITING_STATE
    //     testname = "WRITE_WAITING_STATE";
    // `else
    //     testname = "RAND_ADDR";
    // `endif
    timeout  = 2000;
    ...
    case (testname)
      ...
      //--------------------------------------------------
      "READ_WAITING_STATE":
        env_o.agt.cfg_gen(30, READ_WAITING_STATE);

      "WRITE_WAITING_STATE":
        env_o.agt.cfg_gen(30, WRITE_WAITING_STATE);
